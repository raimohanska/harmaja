...
export function testRender<T>(init: T, test: (property: Rx.Observable<T>, set: (v: T) => any) => HarmajaOutput) {
...
export function map<A, B>(observable: Rx.Observable<A>, fn: (a: A) => B): Rx.Observable<B> {
