...
declare global {
   ...
   //
    ...
    type EventHandler<E extends HarmajaEvent<any>> = { bivarianceHack(event: E): void }["bivarianceHack"];
    ...
    interface DOMAttributes<T> {
        ...
        onErrorCapture?: EventHandler<HarmajaEvent<T>>; // also a Media Event
