...
export declare function attachOnMount(element: HTMLElement | Text, onMount: Callback): void;
export declare function attachOnUnmount(element: HTMLElement | Text, onUnmount: Callback): void;
export declare function detachOnUnmount(element: HTMLElement | Text, onUnmount: Callback): void;
...
export declare function appendElement(rootElement: HTMLElement, child: DOMElement): void;
export {};
